...
from app.domain.shared.agent.prompts.system1_historico import SISTEMA1_HISTORICO_PROMPT
...
def create_system1_historico_agent(
    ...
    Args:
        ...
        system_prompt: Optional override for the default SISTEMA1_HISTORICO_PROMPT.
                       Used by reactive domain to inject event-specific context.
    ...
    effective_prompt = system_prompt or SISTEMA1_HISTORICO_PROMPT
