...
Provides:
  - UserScopedStoreBackend: Persistent store namespaced by user_id
    (memories survive across threads/conversations)
  - create_composite_backend: Factory that routes /memories/ → persistent,
