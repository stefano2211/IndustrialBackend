...
from app.domain.proactiva.services.vl_mlops_service import VLMLOpsService
...
class WebhookPayload(BaseModel):
    ...
    download_url: Optional[str] = None  # URL directa de descarga pre-firmada por el worker
...
async def ota_model_update(
    ...
    if payload.model_type == "vision":
        ...
        bg_tasks.add_task(service.process_ota_webhook, payload.model_tag, payload.tenant_id, payload.download_url)
        return {
            "status": "accepted",
            "model_type": "text",
